...
{
	public class WildfireCardController : CardController
	{
		public WildfireCardController(Card card, TurnTakerController turnTakerController) : base(card, turnTakerController)
		{
		}
