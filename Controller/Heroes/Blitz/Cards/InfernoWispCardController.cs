...
namespace SybithosInfernyx.Blitz
{
    public class InfernoWispCardController : CardController
    {
        ...
        private const string BlitzDealtEnoughDamage = "BlitzDealtEnoughDamage";
